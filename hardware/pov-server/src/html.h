...
<body >
  <div class="container">
    ...
    <div class="group-selector">
      ...
      <select name="group" id="group" onchange="selectGroup()">
        ...
        <option value="1">1c1</option>
        <option value="2">bach</option>
        <option value="3">chachacha</option>
        <option value="4">kalinka</option>
        <option value="5">marche turque</option>
        <option value="6">marin</option>
        <option value="7">pascal</option>
        <option value="8">ragtime</option>
      </select>
    </div>
    ...
    <div class="anim-container">
      ...
      <button class="anim-7">Animation 7</button>
      <button class="anim-8">Animation 8</button>
    </div>
  ...
  <script>
    ...
    if (document.querySelector('.anim-7')) {
      const anim7Btn = document.querySelector('.anim-7');
      anim7Btn.addEventListener('click', () => {
        setAnimation(7);
      });
    }
    if (document.querySelector('.anim-8')) {
      const anim8Btn = document.querySelector('.anim-8');
      anim8Btn.addEventListener('click', () => {
        setAnimation(8);
      });
    }
    ...
    function selectGroup() {
      ...
      // Fetch route GET /api/display/group?group= + group
      fetch(`/api/display/group?group=${group}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
